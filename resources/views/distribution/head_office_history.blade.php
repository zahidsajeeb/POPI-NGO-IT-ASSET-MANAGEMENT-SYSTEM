            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Head office Distribution Report</h4>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card-group-control card-group-control-right">
                            <div class="card mb-2">
                                ...
                                {{--                                    <h3 class="card-title" style="font-weight:bold;">Head office Distribution Lists</h3>--}}
                                {{--                                </div>--}}
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4>Employee Name/Department/ID Wise Search</h4>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <select id="employee_name" class="filter form-control" data-column-index='5'>
                                        ...
                                        <div class="col-md-3">
                                            <select id="employee_id" class="form-control required" data-column-index='6'></select>
                                            {{--                                            <select id="emp_id" class="filter form-control" data-column-index='5'>--}}
                                        ...
                                        <div class="col-md-3">
                                            <select id="employee_dept" class="form-control required" data-column-index='7'></select>
                                            {{--                                            <select id="emp_dept" class="filter form-control" data-column-index='6'>--}}
                                            {{--                                                <option value="">-Select Department-</option>--}}
                                            {{--                                                @foreach($emp_dept_list as $row)--}}
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-12">
                                            <h4>Department Wise Search</h4>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <select id="emp_dept" class="filter form-control" data-column-index='7'>
                                                <option value="">-Select Department-</option>
                                                @foreach($emp_dept_list as $row)
                                                    <option value="{{$row->department_name}}">{{$row->department_name}}</option>
                                                @endforeach
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="distribution_history_table" style="border:1px solid; text-align:center;width:100% !important;">
                                                    <thead style="background:#194d83;color:white; text-align:center;">
                                                    <tr>
                                                        <th class="text-center">#</th>
                                                        <th class="text-center">Asset Code12</th>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $.each(result.department_name, function (key, value) {
                        $("#employee_dept").append('<option value="' + value
                            .department_name + '">' + value.department_name + '</option>');
                    });
                }
            });
        });
...
<script>
    ...
    $(document).ready(function () {
        $('#distribution_history_table thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#distribution_history_table thead');
        ...
        var table = $('#distribution_history_table').DataTable({
            columnDefs: [
                {
                    searchable: false,
                    orderable: false,
            ...
            "buttons": [
                {
                    ...
                    customize: function (doc) {
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                ...
                                                {text: '(Head office Distribution Report) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
                        ...
                        doc.content[0].table.widths = ['5%', '10%', '10%', '10%', '10%', '10%', '10%', '10%', '10%', '10%', '5%'];
                    }
                }],
            "ajax": "{{ url('distribution/history/head_office_history_list') }}",
            "columns": [
