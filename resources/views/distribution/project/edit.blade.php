                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="col-md-12" style="margin-bottom:10px;">
                                                                ...
                                                                <select name="project_id" class="form-control" readonly style="border-radius: 0px !important; border-color: #604c4c69 !important; background:#80808024;">
                                                                    <option value="{{$edit_project_name->id}}">{{$edit_project_name->project_name}}</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-12" style="margin-bottom:10px;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-md-12" style="margin-bottom:10px;">
                                                                <label style="font-weight:bold;">Edit Project Name:</label> <br>
                                                                <select name="edit_project_id" class="form-control project_name" id="project_name" style="border-radius: 0px !important; border-color: #604c4c69 !important;">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data['status']=='success'){
                            swal({
                                icon: 'success',
                                title: 'Project Distribution Update Successfully !!!',
