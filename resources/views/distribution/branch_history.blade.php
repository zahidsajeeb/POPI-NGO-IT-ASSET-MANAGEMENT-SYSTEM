            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Branch Distribution Report12</h4>
                    </div>
...
{{--                                </div>--}}
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <select id="region" class="filter form-control region_name" data-column-index='5'>
                                        ...
                                        <div class="col-md-3">
                                            <select id="zone" id="zone_name" class="filter form-control zone_name" data-column-index='6'></select>
                                        </div>
                                        <div class="col-md-3">
                                            <select id="branch" class="filter form-control branch_name" data-column-index='7'></select>
                                        </div>
{{--                                        <div class="col-md-3">--}}
{{--                                            <select id="region" class="filter form-control" data-column-index='4'>--}}
{{--                                                <option value="">-Select Region-</option>--}}
{{--                                                @foreach($region_list as $row)--}}
{{--                                                    <option value="{{$row->region_name}}">{{$row->region_name}}</option>--}}
{{--                                                @endforeach--}}
...
{{--                                        </div>--}}
{{--                                        <div class="col-md-3">--}}
{{--                                            <select id="zone" class="filter form-control" data-column-index='5'>--}}
...
{{--                                        </div>--}}
{{--                                        <div class="col-md-3">--}}
{{--                                            <select id="branch" class="filter form-control" data-column-index='6'>--}}
            ...
            "buttons": [
                {
                    ...
                    customize: function (doc) {
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                ...
                                                {text: '(Branch Distribution Report) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
                        ...
                        doc.content[0].table.widths = ['5%', '10%', '10%', '10%', '10%', '10%', '10%', '10%', '5%', '10%','5%','5%'];
                    }
                }],
            "ajax": "{{ url('distribution/history/branch_history_list') }}",
            "columns": [
