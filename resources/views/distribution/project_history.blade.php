            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Project Distribution Report</h4>
                    </div>
            ...
            "buttons": [
                {
                    ...
                    customize: function (doc) {
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                ...
                                                {text: '(Project Distribution Report) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
                        ...
                        doc.content[0].table.widths = ['5%', '10%', '15%', '10%', '10%', '10%', '15%', '5%', '10%', '10%'];
                    }
                }],
            "ajax": "{{ url('distribution/history/project_history_list') }}",
            "columns": [
