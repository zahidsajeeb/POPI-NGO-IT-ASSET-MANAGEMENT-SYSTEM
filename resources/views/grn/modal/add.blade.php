<div id="modal_grn_add" class="modal fade" tabindex="-1" style=" border-radius: 0px !important;">
    <div class="modal-dialog modal-lg" style=" border-radius: 0px !important;">
        <div class="modal-content">
            <div class="modal-header bg-indigo text-white" style=" border-radius: 0px !important;">
                <h6 class="modal-title"><i class="fa fa-plus"></i> GRN Add</h6>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="" method="post" id="add_grn_purchase_form">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="bill_no" readonly>
                                    <input type="hidden" class="form-control h-auto" name="item_id" id="bill_id">
                                </div>
                                <div class="col-md-6">
                                    <label style="font-weight:bold;">GRN No:</label> <br>
                                    <input type="text" name="grn_no" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <button type="submit" id="save_employee" class="btn btn-sm btn-success"
...
<div id="modal_grn_servicing_add" class="modal fade" tabindex="-1" style=" border-radius: 0px !important;">
    <div class="modal-dialog modal-lg" style=" border-radius: 0px !important;">
        <div class="modal-content">
            <div class="modal-header bg-indigo text-white" style=" border-radius: 0px !important;">
                <h6 class="modal-title"><i class="fa fa-plus"></i> GRN Add</h6>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="" method="post" id="add_grn_servicing_form">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="alert alert-danger print-error-msg" style="display:none">
                                        <ul></ul>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label style="font-weight:bold;">Bill No:</label> <br>
                                    <input type="text" class="form-control" id="servicing_bill_no" readonly>
                                    <input type="hidden" class="form-control h-auto" name="item_id" id="servicing_bill_id">
                                </div>
                                <div class="col-md-6">
                                    <label style="font-weight:bold;">GRN No:</label> <br>
                                    <input type="text" name="grn_no" class="form-control" autocomplete="off">
...
<div id="modal_grn_purchase_edit" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-indigo text-white">
                <h6 class="modal-title"><i class="fa fa-cart-plus"></i> GRN Edit (Purchase)</h6>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="" method="post" id="edit_grn_purchase_form">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="alert alert-danger print-error-msg" style="display:none">
                                        <ul></ul>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label style="font-weight:bold;">GRN No:</label> <br>
                                    <input type="text" name="grn_no" id="edit_grn_purchase_no" class="form-control">
                                    <input type="hidden" class="form-control h-auto" name="id" id="edit_grn_purchase_id">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
...
<div id="modal_grn_servicing_edit" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-indigo text-white">
                <h6 class="modal-title"><i class="fa fa-cart-plus"></i> GRN Edit (Servicing)</h6>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="" method="post" id="edit_grn_servicing_form">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="alert alert-danger print-error-msg" style="display:none">
                                        <ul></ul>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label style="font-weight:bold;">GRN No:</label> <br>
                                    <input type="text" name="grn_no" id="edit_grn_servicing_no" class="form-control">
                                    <input type="hidden" class="form-control h-auto" name="id" id="edit_grn_servicing_id">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
...
<script>
    ...
    $(function () {
        ...
        var table = $('#bill_table_purchase').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('bill_list_purchase') }}",
            columns: [
        ...
        var table = $('#bill_table_service').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('bill_list_servicing') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'action', name: 'action', orderable: false, searchable: true},
                {data: 'billing_number', name: 'billing_number'},
                {data: 'servicing_vendor_name', name: 'servicing_vendor_name'},
                {data: 'billing_amount', name: 'billing_amount'},
            ]
        });
        var table = $('#grn_purchase_table').DataTable({
            columnDefs: [
                {
                    searchable: false,
                    orderable: false,
            ...
            "buttons": [
                {
                    ...
                    customize: function (doc) {
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                {text: 'Peoples Oriented Program Implementation (POPI) ', bold: true}, '\n',
                                                {text: '(PURCHASE GRN LIST) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
                                ...
                                columns: [
                                    {
                                        ...
                                        text: [{ text: 'This form/report is system generated', bold: true, border:true }]
                                    }
                                ],
                                margin: [10, 0]
                            }
                        ...
                        doc.content[0].table.widths = ['10%', '45%', '45%'];
                    }
                }],
            "ajax": "{{ url('grn_list_purchase') }}",
            "columns": [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'action', name: 'action', orderable: false, searchable: true},
                {data: 'bill_no', name: 'bill_no'},
        ...
        var table = $('#grn_servicing_table').DataTable({
            columnDefs: [
                {
                    searchable: false,
                    orderable: false,
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                {text: 'Peoples Oriented Program Implementation (POPI) ', bold: true}, '\n',
                                                {text: '(SERVICING GRN LIST) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
        ...
        var table = $('#grn_purchase_table121212').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('grn_list_purchase') }}",
            columns: [
        ...
        var table = $('#grn_servicing_table12212121').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('grn_list_servicing') }}",
            columns: [
    ...
    if ($("#add_grn_purchase_form").length > 0) {
        $("#add_grn_purchase_form").validate({
            rules: {
                grn_no: {
                    required: true,
                },
            ...
            submitHandler: function (form) {
                ...
                $('#store').html('Sending..');
                $.ajax({
                    url: 'grn_purchase_store',
                    type: "POST",
                    data: $('#add_grn_purchase_form').serialize(),
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        if ($.isEmptyObject(data.error)) {
                            $('#add_grn_purchase_form').trigger("reset");
                            swal({
                                icon: 'success',
                                title: 'GRN Stored Successfully !!!',
                                showConfirmButton: true,
                                timer: 2500
                            });
                            $('#modal_grn_purchase_add').modal('hide');
    ...
    if ($("#add_grn_servicing_form").length > 0) {
        $("#add_grn_servicing_form").validate({
            rules: {
                grn_no: {
                    required: true,
                },
            ...
            submitHandler: function (form) {
                ...
                $('#store').html('Sending..');
                $.ajax({
                    url: 'grn_servicing_store',
                    type: "POST",
                    data: $('#add_grn_servicing_form').serialize(),
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        if ($.isEmptyObject(data.error)) {
                            $('#add_grn_servicing_form').trigger("reset");
                            swal({
                                icon: 'success',
                                title: 'GRN Stored Successfully !!!',
                                showConfirmButton: true,
                            ...
                            $('#modal_grn_servicing_add').modal('hide');
                            $('#grn_table').DataTable().ajax.reload();
                            setInterval('location.reload()', 1000);
                        } else {
                            printErrorMsg(data.error);
                        }
    ...
    if ($("#edit_grn_purchase_form").length > 0) {
        $("#edit_grn_purchase_form").validate({
            rules: {
                grn_no: {
                    required: true,
                },
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: 'grn_purchase_update',
                    type: "POST",
                    data: $('#edit_grn_purchase_form').serialize(),
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        if ($.isEmptyObject(data.error)) {
                            $('#edit_grn_purchase_form').trigger("reset");
                            swal({
                                icon: 'success',
                                title: 'GRN Update Successfully !!!',
                                showConfirmButton: true,
                                timer: 2500
                            });
                            $('#modal_grn_purchase_edit').modal('hide');
                            $('#grn_purchase_table_table').DataTable().ajax.reload();
                            setInterval('location.reload()', 1000);
                        } else {
                            printErrorMsg(data.error);
                        }
    ...
    if ($("#edit_grn_servicing_form").length > 0) {
        $("#edit_grn_servicing_form").validate({
            rules: {
                grn_no: {
                    required: true,
                },
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: 'grn_servicing_update',
                    type: "POST",
                    data: $('#edit_grn_servicing_form').serialize(),
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        if ($.isEmptyObject(data.error)) {
                            $('#edit_grn_servicing_form').trigger("reset");
                            swal({
                                icon: 'success',
                                title: 'GRN Update Successfully !!!',
                                showConfirmButton: true,
                            ...
                            $('#modal_grn_servicing_edit').modal('hide');
                            $('#grn_servicing_table').DataTable().ajax.reload();
                            setInterval('location.reload()', 1000);
                        } else {
                            printErrorMsg(data.error);
                        }
    ...
    $('body').on('click', '#add_grn_purchase', function () {
        var id = $(this).data('id');
        $.ajax({
            type: "get",
            url: "bill_info_purchase/" + id,
            success: function (data) {
                $('#modelHeading').html("Edit Product");
                $('#saveBtn').val("edit-user");
                $('#modal_grn_add').modal('show');
                $('#bill_id').val(data.id);
    ...
    $('body').on('click', '#add_grn_servicing', function () {
        var id = $(this).data('id');
        $.ajax({
            type: "get",
            url: "bill_info_servicing/" + id,
            success: function (data) {
                $('#modelHeading').html("Edit Product");
                $('#saveBtn').val("edit-user");
                $('#modal_grn_servicing_add').modal('show');
                $('#servicing_bill_id').val(data.id);
                $('#servicing_bill_no').val(data.billing_number);
            },
            error: function (data) {
                console.log('Error:', data);
            }
    ...
    $('body').on('click', '#edit_grn_purchase', function () {
        var id = $(this).data('id');
        $.ajax({
            type: "get",
            url: "grn_info_purchase/" + id,
            success: function (data) {
                $('#modelHeading').html("Edit Product");
                $('#saveBtn').val("edit-user");
                $('#modal_grn_purchase_edit').modal('show');
                $('#edit_grn_purchase_id').val(data.id);
                $('#edit_grn_purchase_no').val(data.grn_no);
            },
            error: function (data) {
                console.log('Error:', data);
            }
    ...
    $('body').on('click', '#edit_grn_servicing', function () {
        var id = $(this).data('id');
        $.ajax({
            type: "get",
            url: "grn_info_servicing/" + id,
            success: function (data) {
                $('#modelHeading').html("Edit Product");
                $('#saveBtn').val("edit-user");
                $('#modal_grn_servicing_edit').modal('show');
                $('#edit_grn_servicing_id').val(data.id);
                $('#edit_grn_servicing_no').val(data.grn_no);
            },
            error: function (data) {
                console.log('Error:', data);
            }
    ...
    $('body').on('click', '#delete_grn_purchase', function () {
        var id = $(this).data("id");
        if (confirm("Do you really want to delete this Branch?")) {
            $.ajax({
                type: "get",
                url: "grn_purchase_delete/" + id,
                success: function (data) {
                        swal({
                            icon: 'success',
                            title: 'GRN Delete Successfully !!!',
                            showConfirmButton: true,
                            timer: 2500
                        });
                        $('#grn_table').DataTable().ajax.reload();
    ...
    $('body').on('click', '#delete_grn_servicing', function () {
        var id = $(this).data("id");
        if (confirm("Do you really want to delete this Branch?")) {
            $.ajax({
                type: "get",
                url: "grn_servicing_delete/" + id,
                success: function (data) {
                    swal({
                        icon: 'success',
                        title: 'GRN Delete Successfully !!!',
