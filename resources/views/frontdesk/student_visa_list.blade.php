                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="counselor_visa_table" style="border:1px solid gray;">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center"  style="font-size:13px;">Chat</th>
                                                <th class="text-center"  style="font-size:13px;">Student ID</th>
                                                <th class="text-center"  style="font-size:13px;">Student Name</th>
                                                <th class="text-center"  style="font-size:13px;">Purpose</th>
                                                <th class="text-center"  style="font-size:13px;">Payment Step</th>
                                                <th class="text-center"  style="font-size:13px;">Payment Status</th>
                                                <th class="text-center"  style="font-size:13px;">Counselor Section Approved</th>
                                                <th class="text-center"  style="font-size:13px;">Admission Section Approved</th>
                                                <th class="text-center"  style="font-size:13px;">Visa Section Approved</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            </tbody>
