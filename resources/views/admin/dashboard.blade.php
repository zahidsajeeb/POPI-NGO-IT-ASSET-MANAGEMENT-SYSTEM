        ...
        <div class="content-inner">
            <div class="page-content">
                ...
                @if(Auth::user()->role==='IT officer')
                    @include('include.it_officer.index')
                @endif
            </div>
            ...
            <script>
                ...
                $(function () {
                    ...
                    var head_table = $('#branch_distribution_table').DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: "{{ url('user_branch_distribution_list') }}",
                        columns: [
                        ...
                        "buttons": [
                            {
                                ...
                                customize: function (doc) {
                                            ...
                                            columns: [
                                                {
                                                    ...
                                                    text:
                                                        [
                                                            ...
                                                            {text: '(Item Asset Report) ', alignment: 'center'},
                                                        ],
                                                    fontSize: 11,
                                                },
                                            ],
                                    ...
                                    doc.content[0].table.widths = ['10%', '25%', '10%', '10%', '10%', '20%', '15%'];
                                }
                            }],
                    } );
                } );
