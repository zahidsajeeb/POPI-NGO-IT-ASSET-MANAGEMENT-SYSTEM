            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Device Service</h4>
                    </div>
                    <div class="navbar-right">
                        <a href="{{url('blank_device_service')}}" class="btn btn-info navbar-right"
                           style="border-radius:0px;"><i class="fa fa-page4"></i> Blank Device Service</a>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Device Service Form</h5>
                            </div>
                            <div class="card-body">
                                <form action="" method="post" id="device_service_add_form">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12" style="margin-bottom:10px;">
                                                <label style="font-weight:bold;">Device Service Serial No:</label> <br>
...
{{--                                                                    <input type="text" name="receiver_name" id="receiver_name" class="form-control receiver_name required" required style="border-radius: 0px !important; border-color: #604c4c69 !important;">--}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Device Service Lists</h5>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="device_service_table"
...
<script>
    ...
    $(function () {
        ...
        var table = $('#device_service_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('device_service_list') }}",
            columns: [
    ...
    if ($("#device_service_add_form").length > 0) {
        $("#device_service_add_form").validate({
            rules: {
                date: {required: true,},
            ...
            submitHandler: function (form) {
                ...
                $('#store').html('Sending..');
                $.ajax({
                    url: 'device_service_store',
                    type: "POST",
                    data: $('#device_service_add_form').serialize(),
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        if ($.isEmptyObject(data.error)) {
                            $('#device_service_add_form').trigger("reset");
                            swal({
                                icon: 'success',
                                title: 'device_service Stored Successfully !!!',
                                showConfirmButton: true,
                                timer: 2500
                            });
                            $('#device_service_table').DataTable().ajax.reload();
                        } else {
    ...
    $('body').on('click', '#delete_device_service', function () {
        var id = $(this).data("id");
        if (confirm("Do you really want to delete this Branch?")) {
            $.ajax({
                type: "get",
                url: "delete_device_service/" + id,
                success: function (data) {
                    swal({
                        icon: 'error',
                        title: 'device_service Delete Successfully !!!',
                        showConfirmButton: true,
                        timer: 2500
                    });
