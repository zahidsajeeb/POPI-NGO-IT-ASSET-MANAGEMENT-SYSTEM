                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Device Service Edit Form</h5>
                            </div>
                            <div class="card-body">
                                <form action="" method="post" id="device_add_form">
    ...
    if ($("#device_add_form").length > 0) {
            $("#device_add_form").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: 'device_service_update',
                        type: "POST",
                        data: $('#device_add_form').serialize(),
                        type: "POST",
                        dataType: 'json',
                        success: function (data) {
                            $('#device_add_form').trigger("reset");
                            swal({
                                icon: 'success',
