            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Gate Pass Show</h4>
                    </div>
                        ...
                        <div class="card" style="border:0px; height:1500px !important;">
                            <div class="card-body">
                                <table class="table" style="border:1px solid;">
                                    ...
                                    <tr>
                                        <td colspan="4" style="border:1px solid;"><h2 style="text-align:center;"><b>Gatepass</b></h2></td>
                                    </tr>
                                    <tr>
