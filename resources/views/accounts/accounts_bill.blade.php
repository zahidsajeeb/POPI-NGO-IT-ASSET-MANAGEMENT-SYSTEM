            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    ...
                    <div class="navbar-right">
                        <a href="{{url('accounts_bill_pdf', $payment_info->id)}}" class="btn btn-lg btn-primary" style="border-radius:0px;"><i class="fa fa-print"></i> Print</a>
                        <a href="{{url('accounts_edit', $payment_info->id)}}" class="btn btn-lg btn-danger" style="border-radius:0px;"><i class="fa fa-edit"></i> Edit</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="invoice">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td colspan="4" style="text-align:center;font-weight:bold; font-size:14px;">Payment History</td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight:bold;">Sl No</td>
                                            <td style="font-weight:bold;">Payment Purpose</td>
