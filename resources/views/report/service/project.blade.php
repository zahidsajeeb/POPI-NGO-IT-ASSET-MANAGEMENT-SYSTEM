            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Project Item Service report</h4>
                    </div>
                        ...
                        <div class="card-group-control card-group-control-right">
                            <div class="card mb-2">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <select id="project_name" class="filter form-control project_name" data-column-index='3'>
                                        ...
                                        <div class="col-md-3">
                                            <select id="branch_name" class="filter form-control branch_name" data-column-index='4'></select>
                                        </div>
                                    </div>
                                    <div class="row mt-5">
                                        <div class="col-md-12">
            ...
            "buttons": [
                {
                    ...
                    customize: function (doc) {
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                ...
                                                {text: '(Item Service Report - Project) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
                        ...
                        doc.content[0].table.widths = ['5%', '10%', '10%', '10%', '10%', '10%', '10%', '10%','10%','5%','5%','5%'];
                    }
                }],
