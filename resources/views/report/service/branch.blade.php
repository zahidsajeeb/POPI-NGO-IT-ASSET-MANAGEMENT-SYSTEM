            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Branch Item Service report</h4>
                    </div>
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" id="service_table" style="border:1px solid; text-align:center;width:100% !important;">
        ...
        var table = $('#service_table').DataTable({
            ...
            "buttons": [
                {
                    ...
                    customize: function (doc) {
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                ...
                                                {text: '(Item Service Report - Branch) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
                        ...
                        doc.content[0].table.widths = ['5%', '10%', '10%', '10%', '10%', '10%', '10%', '5%', '5%', '10%', '5%', '5%','5%'];
                    }
                }],
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                while (j < nb_cols) {
                    ...
                    $(api.column(11).footer()).html(pageTotal + ' TK');
                    j++;
                }
            },
        });
