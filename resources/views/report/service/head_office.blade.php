            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Head office Item Service report</h4>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $('#service_table').DataTable({
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                ...
                                                {text: '(Item Service Report- Head office) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
            ...
            "ajax": "{{ url('report/head_office_servicing_list') }}",
            "columns": [
