            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Report</span> - Branch Item Return</h4>
                    </div>
            ...
            "buttons": [
                {
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[0].table.widths = ['5%', '10%', '10%', '25%', '10%', '10%', '10%', '10%','10%'];
                    }
                }],
            "ajax": "{{ url('report/branch_return_list') }}",
            "columns": [
