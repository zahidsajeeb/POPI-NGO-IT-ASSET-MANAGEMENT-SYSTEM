            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Report</span> - Project Item Return</h4>
                    </div>
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="return_table" style="border:1px solid; text-align:center;width:100% !important;">
...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $('#return_table').DataTable({
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                ...
                                                {text: '(Item Return Report) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
            ...
            "ajax": "{{ url('report/project_return_list') }}",
            "columns": [
