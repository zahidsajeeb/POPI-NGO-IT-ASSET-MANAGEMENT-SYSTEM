                    ...
                    <div class="col-md-12" id="printableArea">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <td colspan="6"><h2 style="text-align:center;">Branch Distribution History</h2></td>
                                    </tr>
                                    <tr style="background:#0000002e; color:black; font-weight:bold;">
                                        <td>#</td>
                                    ...
                                    @if(isset($branch_distribution_list))
                                        @foreach($branch_distribution_list as $key=>$row)
                                            <tr>
                                                <td>{{++$key}}</td>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="6" style="text-align:center;"><b style="text-align:center;">No Data Found</b></td>
                                        </tr>
                                    @endif
                                </table>
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <td colspan="6"><h2 style="text-align:center;">Head office Distribution History</h2></td>
                                    </tr>
                                    <tr style="background:#0000002e; color:black; font-weight:bold;">
                                        <td>#</td>
                                        <td>Distribution Date</td>
                                    ...
                                    @foreach($head_office_distribution_list as $key=>$row)
                                        <tr>
                                            <td>{{++$key}}</td>
                                            <td>
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <td colspan="8"><h2 style="text-align:center;">Project Distribution History</h2></td>
                                    </tr>
                                    <tr style="background:#0000002e; color:black; font-weight:bold;">
                                        <td>#</td>
                                        <td>Distribution Date</td>
                                    ...
                                    @if(isset($project_distribution_list)!='')
                                        @foreach($project_distribution_list as $key=>$row)
                                            <tr>
                                                <td>{{++$key}}</td>
                                                <td>{{$row->distribution_date}}</td>
                                                <td>{{$row->return_date}}</td>
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <td colspan="8"><h2 style="text-align:center;">Servicing History</h2></td>
                                    </tr>
                                    <tr style="background:#0000002e; color:black; font-weight:bold;">
                                        <td>#</td>
                                        <td>Billing No</td>
                                        ...
                                        <td>Details</td>
                                        <td>Vendor</td>
                                        <td>Servicing Sending Date</td>
                                        <td>Servicing Return Date</td>
                                        <td>Warranty</td>
                                    </tr>
                                        @foreach($servicing_list as $key=>$row)
                                            <tr>
                                                <td>{{++$key}}</td>
                                                <td>{{$row->billing_number}}</td>
                                                <td>{{$row->billing_amount}}</td>
                                                <td>{{$row->details}}</td>
                                                <td>{{$row->servicing_vendor_name}}</td>
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <td colspan="8"><h2 style="text-align:center;">Recycle History</h2></td>
                                    </tr>
                                    <tr style="background:#0000002e; color:black; font-weight:bold;">
                                        <td>#</td>
                                        <td>Recycle Date</td>
                                    ...
                                    @foreach($recycle_list as $key=>$row)
                                        <tr>
                                            <td>{{++$key}}</td>
                                            <td>{{$row->recycle_date}}</td>
                                            <td>{{$row->recycle_remarks}}</td>
                                        </tr>
                                    @endforeach
                                </table>
                            </div>
