            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Item Service report</h4>
                    </div>
                        ...
                        <div class="card-group-control card-group-control-right">
                            <div class="card mb-2">
                                <div class="card-header">
                                    <h6 class="card-title">
                                        <a class="text-body collapsed" data-toggle="collapse" href="#available_item_1">
                                            <i class="icon-help mr-2 text-secondary"></i> Branch Item Service Report
                                        </a>
                                    </h6>
                                </div>
                                <div id="available_item_1" class="collapse">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            <h4>Region/Zone/Branch Wise Search</h4>
                                            <hr>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <select id="region" class="filter form-control region_name" data-column-index='3'>
                                            ...
                                            <div class="col-md-3">
                                                <select id="zone" id="zone_name" class="filter form-control zone_name" data-column-index='4'></select>
                                            </div>
                                            <div class="col-md-3">
                                                <select id="branch" class="filter form-control branch_name" data-column-index='5'></select>
                                            </div>
                                        </div>
                                        <div class="row mt-5">
                                            <div class="col-md-12">
                                                <h4>Date Wise Search</h4>
                                                <hr>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" id="min" name="min" class="form-control" placeholder="Start Date" autocomplete="off">
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" id="max" name="max" class="form-control" placeholder="End Date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="row mt-5">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" id="b_service_table" style="border:1px solid; text-align:center;width:100% !important;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="text-align:center;">Servicing Bill Number</th>
                                                            <th style="text-align:center;">Servicing Bill Amount</th>
                                                            <th style="text-align:center;">Servicing Send</th>
                                                            <th style="text-align:center;">Servicing Return</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        </tbody>
                                ...
                                <div class="card-header">
                                    <h6 class="card-title">
                                        <a class="text-body collapsed" data-toggle="collapse" href="#available_item">
                                            <i class="icon-help mr-2 text-secondary"></i> Head office Item Service Report
                                        </a>
                                    </h6>
                                </div>
                                <div id="available_item" class="collapse">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" id="servicing_table" style="border:1px solid; text-align:center;width:100% !important;">
                                                        <thead style="background:#194d83;color:white; text-align:center;">
                                                        <tr>
                                                            <th style="text-align:center;">#</th>
                                                            <th style="text-align:center;">Asset Code</th>
                                                            ...
                                                            <th style="text-align:center;">Vendor Name</th>
                                                            <th style="text-align:center;">Item Name</th>
                                                            <th style="text-align:center;">Servicing To</th>
                                                            <th style="text-align:center;">Servicing Return</th>
                                                            <th style="text-align:center;">Service Warranty</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        </tbody>
                        ...
                        <div class="card-group-control card-group-control-right">
                            <div class="card mb-2">
                                <div class="card-header">
                                    <h6 class="card-title">
                                        <a class="text-body collapsed" data-toggle="collapse" href="#available_item">
                                            <i class="icon-help mr-2 text-secondary"></i> Project Item Service Report
                                        </a>
                                    </h6>
                                </div>
                                <div id="available_item" class="collapse">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4>Project/Branch Wise Search</h4>
                                                <hr>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <select id="project_name" class="filter form-control project_name" data-column-index='5'>
                                            ...
                                            <div class="col-md-3">
                                                <select id="branch_name" class="filter form-control branch_name" data-column-index='6'></select>
                                            </div>
                                        </div>
                                        <div class="row mt-5">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" id="p_service_table" style="border:1px solid; text-align:center;width:100% !important;">
                                                        <thead style="background:#194d83;color:white; text-align:center;">
                                                        <tr>
                                                            <th style="text-align:center;">#</th>
                                                            <th style="text-align:center;">Asset Code</th>
...
<script>
    ...
    $(document).ready(function () {
        $('#b_service_table thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#b_service_table thead');

        $('#p_service_table thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#p_service_table thead');

        minDate = new DateTime($('#b_min'), {
            format: 'MMMM Do YYYY'
        });
        maxDate = new DateTime($('#b_max'), {
            format: 'MMMM Do YYYY'
        });
        var table = $('#b_service_table').DataTable({
            "searchPane": true,
            ...
            "buttons": [
                {
                    ...
                    customize: function (doc) {
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                ...
                                                {text: '(Item Service Report) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
                        ...
                        doc.content[0].table.widths = ['10%', '10%', '10%', '30%', '10%', '10%', '10%', '10%'];
                    }
                }],
            "ajax": "{{ url('report/branch_servicing_list') }}",
            "columns": [
            ...
            //         $(api.column(2).footer()).html(pageTotal + ' Kg');
            //         j++;
            //     }
            // },
        });
        var table = $('#p_service_table').DataTable({
            "searchPane": true,
            "dom": '<"dt-buttons"Bf><"clear">lirtp',
            "orderCellsTop": true,
            "fixedHeader": true,
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                {text: 'Peoples Oriented Program Implemantation (POPI) ', bold: true}, '\n',
                                                {text: '(Item Service Report) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
            ...
            "ajax": "{{ url('report/project_servicing_list') }}",
            "columns": [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'asset_code', name: 'asset_code'},
                {data: 'serial_no', name: 'serial_no'},
        ...
        $('.filter').on('change', function () {
            ...
            if (val.length > 1) {
                ...
                table.column($(this).data('columnIndex'))
