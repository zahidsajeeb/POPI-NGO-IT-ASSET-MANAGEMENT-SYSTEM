            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Item Recycle Report</h4>
                    </div>
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="recycle_table" style="border:1px solid; text-align:center;width:100% !important;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center">Recycle Date</th>
                                                        <th class="text-center">Recycle Qty</th>
                                                         <th class="text-center">Recycle Location</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#recycle_table thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#recycle_table thead');
