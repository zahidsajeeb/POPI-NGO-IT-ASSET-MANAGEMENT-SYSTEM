            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Item Costing report</h4>
                    </div>
                        ...
                        <div class="card-group-control card-group-control-right">
                            <div class="card mb-2">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <select id="employee_name" class="filter form-control" data-column-index='3'>
                                        ...
                                        <div class="col-md-3">
                                            <select id="employee_id" class="form-control required" data-column-index='4'></select>
                                        </div>
                                        <div class="col-md-3">
                                            <select id="employee_dept" class="form-control required" data-column-index='5'></select>
                                        </div>
                                    </div>
                                    <div class="row mt-5">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="costing_table" style="border:1px solid; text-align:center;width:100% !important;">
...
<script>
    ...
    $(document).ready(function () {
        // $('#costing_table thead tr')
        //     .clone(true)
        //     .addClass('filters')
        //     .appendTo('#costing_table thead');
        ...
        var table = $('#costing_table').DataTable({
                                ...
                                columns: [
                                    {
                                        ...
                                        text:
                                            [
                                                ...
                                                {text: '(Costing Report) ', alignment: 'center'},
                                            ],
                                        fontSize: 11,
                                    },
                                ],
            ...
            "ajax": "{{ url('report/head_office_costing_list') }}",
            "columns": [
                ...
                {data: 'qty', name: 'action', orderable: false, searchable: true},
                {data: 'unit_price', name: 'action', orderable: false, searchable: true},
                {data: 'total_price', name: 'action', orderable: false, searchable: true},
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                while (j < nb_cols) {
                    ...
                    $(api.column(10).footer()).html(pageTotal + ' TK');
                    j++;
                }
            },
        });
