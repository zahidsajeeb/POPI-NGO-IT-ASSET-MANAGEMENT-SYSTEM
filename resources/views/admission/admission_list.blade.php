            ...
            <div class="content-inner">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="admin_admission_table" style="border:1px solid gray;">
                ...
                <script>
                    ...
                    $(function () {
                        ...
                        var immigration_table = $('#admin_admission_table').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: "{{ url('admin_admission_student_list') }}",
                            columns: [
